...
const prefix = "/"
const keep_alive = require("/home/runner/keep_alive.js")
...
client.on('message', msg => {
  ...
  // Définition des fonctions de permissions sur les commandes
  function deleteCommand(msg){
  if (msg.guild.id != "439071793274421259"){
  msg.delete()
  }
}
...
// statut  
  ...
  .setDescription("Nouveau statut du bot : **" + nouveauJeu + "**.")
  .setFooter(footer, client.user.avatarURL)
  .setColor("RANDOM")
